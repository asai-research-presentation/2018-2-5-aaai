...
** Task: Solving an Imaged-Based 8-puzzle */without any Prior Explicit Knowledge/*
...
* SAE ∈ AutoEncoder (AE): Unsupervised Learning for NN
...
* Solution: SAE as a Gumbel-Softmax VAE (Jang, Gu, ICLR2017)
...
** Action Auto Encoder → */Incorrect Transitions/*

 [[png:ama/overview1-1]]

** Action Discriminator → */Prunes the Incorrect/*
