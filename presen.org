...
#+begin_larger
#+begin_alignright
→ *AMA_2*, a novel neural architecture which finds

*Actions Symbols* & *Action Models*
#+end_alignright
#+end_larger

* The Task of AMA_2 : The */Real/* AMA method

Perform the following with limited examples (all unsupervised):
...
** The challenge : Latplan Training Input lacks Action Symbols

*Just pairs of images*

[[png:ama/action-symbol]]

+ Lacks the information regarding *which transitions are of the same type*

** Precondition/Effect learning: Is it trivial?
...
+ AMA reduces to a *prediction task* (common in scene prediction in video)
