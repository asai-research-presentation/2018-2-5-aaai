...
#+begin_row-fluid
#+begin_span6
+ The manual overhead of converting real-world problems into inputs for
...
#+begin_xlarge
Exisiting Knowledge Acquisition Techniques
#+end_xlarge
...
* Limitatins of Existing Systems

All existing systems require symbolic, discrete labels

|                 | (1) Action Labels | (2) State Feature | (3) Feature Value      | Contribution          |
|-----------------+-------------------+-------------------+------------------------+-----------------------|
| Konidaris et al | *Known*           | *Structured*      | Probabilistic/Discrete | Semi-MDP → Classical |
| LOCM            |                   |                   |                        |                       |
|                 |                   |                   |                        |                       |
...
*No Plan Examples* : No labels distinguishing actions
...
#+begin_larger
+ You can't directly apply previous KEPS-community work to this, there's *no symbolic representation*
#+end_larger
