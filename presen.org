...
+ */Action Model Acquisition/ (AMA): Describe the actions with symbols*
...
#+begin_alignright
#+begin_xlarge
+ → */Latplan/* architechture
#+end_xlarge
#+end_alignright

#+begin_resume
before our paper, there was no such system that can do this automatically
#+end_resume
...
***TODO*** there is no labeled information describig what is happening in each transition.
...
#+end_span6
#+begin_span6
*Latplan performs a /symbolic, propositional reasoning/ in the symbolic latent space*.

An instance of *Physical Symbol Systems*:
