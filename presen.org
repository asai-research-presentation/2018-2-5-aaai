...
+ Key idea: *These categorical variables are /directly/ usable*
  ...
  *as a source of propositional reasoning*
...
#+end_span6
#+begin_span6
+ We need a positive and a negative dataset in order to train a binary classifier
+ but hey, wait, *where are the negative examples?*
#+end_span6
#+end_row-fluid
#+end_container-fluid

** Negative examples are NEVER observed in the real world

Does a robot have chance to observe *teleportation* ?

[[png:aae/teleportation]]

*No*, since teleportation *violate the laws of physics*.
