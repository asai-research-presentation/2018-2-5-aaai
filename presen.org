...
+ *Entire raw state transitions* in the environment are given
...
SAE: *trained with 20k images*, *generalizes to > 360k entire states* in 8-puzzle

AMA_1 : *oracular method*
...
+ *Latplan:* *The /first system/ in history* which completely automatically generates a symbolic model from scratch
