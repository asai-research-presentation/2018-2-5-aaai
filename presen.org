...
** Goal: Solving */Imaged-Based/* 8-puzzle w/o Prior Explicit Knowledge
...
** Goal: Solving */ANY/* Imaged-Based tasks w/o Prior Explicit Knowledge
...
Using SAE, we propose LatPlan *architechture*, and *LatPlanα*, an implementation
